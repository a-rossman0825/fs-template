...
<template>
  <div class="card p-2">
    <div class="card-body text-light p-4">
      <h4 class="h1 pb-2">Full Stack Project Template</h4>
      <p class="h5 fw-light pb-4">A comprehensive, production-ready template combining modern frontend and backend technologies for rapid application development.</p>
...
<style lang="scss" scoped>
  ...
  .card-body {
    text-shadow: 1px 1px 3px var(--bs-dark);
  }
